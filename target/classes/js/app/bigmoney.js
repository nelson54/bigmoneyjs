define(['app/currencyunit', 'app/lib/bigdecimal-require', 'app/lib/underscore'], function(CurrencyUnit, bigdecimal, _) {

    var BigDecimal = window.BigDecimal = bigdecimal.BigDecimal,
