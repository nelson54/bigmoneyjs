define(['app/lib/underscore'], function(_) {
...
/*function addHashByKeyToObjectAtPosition(array, idPosition){
    var object = {};
    _.each(array, function(ar){
        if (object[ar[idPosition]]) object[ar[idPosition]] = ar;
    });
    return object;
}
...
currencyData.currenciesByCode = addHashByKeyToObjectAtPosition(data, 1);
currencyData.currenciesByNumericCode = addHashByKeyToObjectAtPosition(data, 2);
currencyData.currenciesByCountry = addHashByKeyToObjectAtPosition(data, 4);*/
