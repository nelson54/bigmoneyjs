define(['app/lib/underscore', 'app/CurrencyData', 'app/lib/currency'], function(_, currencyData, currency) {

    var CurrencyUnit = window.CurrencyUnit = function(code, numericCode, country, decimalPlaces){
        this.code = code;
